...
import { consultingFacts, contactEmail } from "@/lib/data";
  ...
  return (
    <section className="relative overflow-hidden px-5 pb-16 pt-32 sm:px-8 md:px-16 md:pt-40">
      ...
      >
        ...
        >
          From <em>readiness</em> to production, governed end-to-end.
        </motion.h1>
        <motion.p
          variants={item}
          className="mb-9 max-w-[560px] text-[clamp(1rem,1.4vw,1.15rem)] text-ink-dim"
        >
          We help enterprises adopt AI responsibly — assessment,
          architecture, and governance through to production deployment and
